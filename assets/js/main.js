...
function init() {
  ...
  addShape( bristolNorthWestShape,  extrudeSettings, 0x001848, 300, 100, 0, 650, 0, 0, 1 );
	addShape( bristolWestShape,  extrudeSettings, 0x604878, 300, 100, 0, 650, 0, 0, 1 );
	addShape( bristolEastShape,  extrudeSettings, 0x906090, 300, 100, 0, 650, 0, 0, 1 );
	addShape( bristolSouthShape,  extrudeSettings, 0x483078, 300, 100, 0, 650, 0, 0, 1 );
