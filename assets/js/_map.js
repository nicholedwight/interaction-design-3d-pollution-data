function createBristol() {
  // var loader = new THREE.GLTFLoader();
  // var url = "Bristol2-6.gltf";
  //
  // loader.load(url, function (data) {
  // 		var object = data.scene;
  // 		bristol = object;
  // 		bristol.position.z = 0;
  // 		bristol.position.x = 0;
  // 		bristol.position.y = 0;
  // 		bristol.dir = 12;
  //     bristol.scale.set(135,135,135);
  //     bristol.rotation.z = 2.5;
